...
@endforeach
<form action="{{URL:: to ('/update_company/' .session('sessionuseremail'))}}" method="post" enctype="multipart/form-data">
                @csrf
        ...
        <div class="card mb-3" style="border-radius: .5rem;">
          <div class="row g-0">
            ...
            <div class="col-md-4 gradient-custom text-center text-white"
              ...
              <br><br>
              <img src="images/{{$pf->profile_image}}"            
                alt="Avatar" id="outImg" class="img-fluid " style="width: 80px;" />

                <input type="file" name="image" class="imageinput p-2 mt-3" onchange="onFileSelected(event)" style="color:#70c745;">
              ...
              <div class="card-body p-4">
                ...
                <div class="row pt-1">
                  ...
                  <div class="col-6 mb-3">
                    ...
                    <input type="text" placeholder="Enter Company Name"
                                onkeypress="return /[a-zA-Z space]/i.test(event.key)" name="contact_no"
                                class="form-control input-sm" value="{{$pf['contact_no']}}" >
                  </div>
                </div>
                <h6>Password</h6>
                <hr class="mt-0 mb-4">
                <div class="row pt-1">
                  <div class="col-6 mb-3">
                    ...
                    <input type="text" placeholder="Enter Company Name"
                                onkeypress="return /[a-zA-Z space]/i.test(event.key)" name="password"
                                class="form-control input-sm" value="{{$pf['password']}}" >
                  </div>
                 
                </div>

                <button type="submit" class="btn btn-primary ml-5 mt-2" style="background-color:#70c745;">Update</button>
