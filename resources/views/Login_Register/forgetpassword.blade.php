                    ...
                    <form action="{{URL:: to('/forgetpassword')}}" method="POST">
                        ...
                        <div><br><br><br><br><br><br>
                            <img src="https://www.mendix.com/wp-content/uploads/low-code-guide-pro-dev.png" alt=""
                                style="height:17rem; width:34rem;">
                            <br><br>
                            <label class="mt-5" for="frm-login-uname"
                                style="font-weight:bold; color:black; margin-left:25px; font-size:2.2rem; color:#F7B205;">Please
                                Provide Email Address</label><br><br>
                            <div class="row">
                                <div class="col-md-3"></div>
                                <div class="col-md-5">
                                    <input type="email" id="frm-login-uname" name="emailinput"
                                        style="border:2px solid black;font-weight:bold; font-size:1.6rem; width:39rem; height:5rem; border-radius:2rem; text-align:center;"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <button class="" type="submit"
                                        style="background-color:#F7B205; width:18rem; font-weight:bold; height:5rem; width:25rem; border-radius:2rem; color:white; font-size:2.5rem;">Forgot
                                        Password</button>
